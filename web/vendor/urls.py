...
from . import views
from .views import edit_product, toggle_product_status, order_detail, UpdateStockView
...
urlpatterns = [
    ...
    path('product/<uuid:pk>/update_stock/', UpdateStockView.as_view(), name='update_stock'),  # Add this line
]